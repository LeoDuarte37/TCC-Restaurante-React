            ...
            <div className="container flex justify-center items-center ">
                <div className="flex flex-col 2xl:w-2/5 xl:w-2/5 md:w-3/4 max-[770px]:w-11/12 rounded-xl bg-white p-6 max-[460px]:p-4 backdrop-blur-2xl">
                    <label className="inline-flex items-center mb-5 cursor-pointer">
                        <input type="checkbox" value="" className="sr-only peer" onClick={changeCheck}></input>
                        ...
                        <span className={check == false ? "ms-3 text-sm font-medium text-[#5E210C]" : "ms-3 text-sm font-medium text-[#D62300]"}>Acessar mesa?</span>
                    </label>
                    ...
                    <div className="div flex-1 flex-col justify-center px-6 py-12 lg:px-8">
                        <div className="caixaContent logo sm:mx-auto sm:w-full sm:max-w-sm">
                            <div className='caixaTitle'>
                                <h1>Bon Chef</h1>
                                <ChefHat size={55} color='rgb(94,33,12)' className="h-[40px] max-[375px]:hidden pl-2" />
                            </div>
