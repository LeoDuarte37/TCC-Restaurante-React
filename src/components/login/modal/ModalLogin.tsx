...
import FormLoginMesa from "../forms/FormLoginMesa";
...
function ModalLogin(props: { mostrar: boolean; }) {
    ...
    return (
        <>
            ...
            <Transition appear show={isOpenMesa}>
                <Dialog as="div" className="relative z-10 focus:outline-none" onClose={() => setIsOpenMesa(false)}>
                    <div className="fixed inset-0 z-10 w-screen overflow-y-auto">
                        <div className="flex min-h-full items-center justify-center p-4">
                            <TransitionChild
                                enter="ease-out duration-300"
