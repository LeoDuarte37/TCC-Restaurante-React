...
function CardCategoria(props: { subCategoria: SubCategoria, isMesa: boolean }) {
    ...
    return (
        <>
            { props.isMesa ? (
                <article key={props.subCategoria.id} className="relative isolate flex flex-col items-center justify-center overflow-hidden rounded-xl p-4 h-full max-w-48 max-h-12 bg-gradient-to-t from-stone-400 via-Stone-100/5">
