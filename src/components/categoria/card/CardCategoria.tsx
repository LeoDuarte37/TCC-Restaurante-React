...
function CardCategoria(props: { categoria: Categoria }) {
    ...
    return (
        <article className="relative isolate flex flex-col justify-end overflow-hidden rounded-2xl pb-4 pt-24 max-w-48 max-h-6">
            ...
            <h1 className="z-10 mt-3 text-3xl text-center font-bold text-white">{props.categoria.nome}</h1>
        </article>
    );
}
